...
namespace yt_DesignUI.Components
{
    public partial class EgoldsFormStyle : Component
    {
        ...
        private Dictionary<fStyle, EBookLib01.Components.EgoldsStyle> StylesDictionary; // Словарь вида: <Стиль из набора, Объект стиля с параметрами>
        private EBookLib01.Components.EgoldsStyle CurrentStyle; // Актуальный стиль, класс с его параметрамы
        ...
        {
            StylesDictionary = new Dictionary<fStyle, EBookLib01.Components.EgoldsStyle>();

            // Стиль стандартной формы, без параметров, кроме HeaderHeight
            StylesDictionary.Add(fStyle.None,
                new EBookLib01.Components.EgoldsStyle()
                {
                    HeaderHeight = 0
                });
        ...
        private void SaveNoneStyleConfig()
        {
            ...
            {
                EBookLib01.Components.EgoldsStyle NoneStyle = StylesDictionary[fStyle.None];
        ...
        private void SaveUserStyleConfig()
        {
            if (StylesDictionary.ContainsKey(fStyle.UserStyle) && StyleUsed == false)
            {
                ...
                EBookLib01.Components.EgoldsStyle UserStyle = StylesDictionary[fStyle.UserStyle];
